package oopproject;
class DeluxeBurgerSandwich extends NormalBurgerSandwich
{
    private String type_of_additions;
    public DeluxeBurgerSandwich(String name, String bread, String meat)
    {
        super(name,bread,meat);
        System.out.println("you'll get a white bread and Beaf meat");
